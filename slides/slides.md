...
# How should we <br> hold each other <br> **accountable** in Christ? 
...
+ But like Roman **centurion**: soldiers under him, 
...
---
1. **Anticipate** Suffering for Christ
1. **Initiate** Support
1. Use **Comfort**, not Coercion
...
+ 3. Had auth to **coerce**, but didn't **exert**:
...
>>>
+ Strengthen + **encourage** in the faith
  + **weak**: not more **discip**, work **ethic**
  + but **equip** + **encourage**
+ As **hubby**/dad: bring comfort
...
+ Or use **blame** / guilt: "all bc of you!"
  + Reveal own **irresponsib** / instability
+ Use strength to **comfort**, not coerce

---
<!-- .slide: data-background="white" -->
# What is the **purpose** <br> of accountability?
<!-- .element: class="r-fit-text" -->
...
---
<!-- .slide: data-background="white" -->
# How do I **pray** for <br> those around me?
<!-- .element: class="r-fit-text" -->

>>>
+ perhaps don't pray very **often**
  + or mostly for **myself**
  + or for others, only **perfunctory**, rote
  + or have all but **given up**
  + that God could **change** them
